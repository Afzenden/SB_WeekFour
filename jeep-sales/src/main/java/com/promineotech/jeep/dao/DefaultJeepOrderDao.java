...
public class DefaultJeepOrderDao implements JeepOrderDao {
    ...
    public List<Option> fetchOptions(List<String> optionIds) {
        ...
        return jdbcTemplate.query(sql, params, (rs, rowNum) -> Option.builder()
    ...
    public Optional<Jeep> fetchModel(JeepModel model, String trim, int doors) {
        ...
        return Optional.ofNullable(jdbcTemplate.query(sql, params, new ModelResultsSetExtractor()));
    }
    ...
    public Optional<Color> fetchColor(String colorId) {
        ...
        return Optional.ofNullable(jdbcTemplate.query(sql, params, new ColorResultsSetExtractor()));
    }
    ...
    class ModelResultsSetExtractor implements ResultSetExtractor<Jeep> {
    ...
    class ColorResultsSetExtractor implements ResultSetExtractor<Color> {
        @Override
